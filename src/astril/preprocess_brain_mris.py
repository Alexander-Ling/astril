...
from .preprocessing_utils import ensure_dcm2niix_accessible
...
def _ensure_dcm2niix_accessible() -> str:
    """Backward-compatible local wrapper around the shared resolver."""
    return ensure_dcm2niix_accessible()
